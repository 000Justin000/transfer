function textborder(x, y, z, string, text_color, border_color, t, varargin)
...
%   Author: João F. Henriques, April 2010
	...
	offsets = [-t, -t; -t, 0; -t, t; 0, -t; 0, t; t, -t; t, 0; t, t];
	for k = 1:8
		h = text(x, y, z, string, 'Color',border_color, varargin{:});
	...
	h = text(x, y, z+1, string, 'Color',text_color, varargin{:});
